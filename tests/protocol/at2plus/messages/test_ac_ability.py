...
class TestAcAbility(unittest.TestCase):
    def test_v1(self):
        ...
        start_group: int = 3
        group_count: int = 2
        supported_modes: list[AcSetMode] = [AcSetMode.HEAT, AcSetMode.FAN, AcSetMode.COOL]
...
class TestAcAbilityMessage(unittest.TestCase):
    def test_response(self):
        ability = AcAbility(1, "helloworld", 3, 2, [AcSetMode.HEAT, AcSetMode.FAN, AcSetMode.COOL], [
